...
ui <- page(
  ...
  layout_columns(
    ...
    div(
      ...
      h2("What does", strong("your 'best' day", style = "color: #78c2ad;"), "look like?", style = "text-align: center;")
    ),
  ...
  navset_card_pill(
    ...
    nav_panel(
      ...
      card(p(
        paste(
          "The aim of this app is to provide you with an idea of what the 'best' 24",
          "hours looks like to improve your knee pain and symptoms.",
          ...
          "what the 'best' 24-hours looks like for the best possible knee function."
        )
      )), 
    ...
    nav_panel(title = "Best day", 
      p("Please be patient, we are inspecting 12,618 time-use profiles to calculate your best day, and your page is currently rendering..."),
      uiOutput("ui0"), 
      layout_columns(
        col_widths = c(2, 8, 2), 
